...
\begin{figure}
	\centering	
	\subfigure[Impact of $PM_{2.5}$]{\includegraphics[scale=0.25]{Final_dust.eps}}
	\hfill
	\subfigure[Impact of $CO_2$]{\includegraphics[scale=0.25]{Final_co2.eps}}
	\subfigure[Humidity level]{\includegraphics[scale=0.25]{Final_humidity_1.eps}}
	\hfill	
	\subfigure[Temperature rise]{\includegraphics[scale=0.25]{Final_temp.eps}}
	\hfill
...
\begin{figure}
	\hfill
	\subfigure[Current Pollution Status]{\includegraphics[width=5cm]{image3.png}}
	\hfill
	\subfigure[Student Profile]{\includegraphics[width=5cm]{image4.png}}
	\hfill
	\centering
	\subfigure[Student Survey]{\includegraphics[width=5cm]{image5.png}}
	\hfill
